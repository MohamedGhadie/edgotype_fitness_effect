...
def main():
    ...
    # output data files
    chainInterfaceFile = procDir / 'chain_interfaces_2.txt'
    ...
    chainAnnotatedInteractomeFile = templateBasedDir / 'chain_annotated_interactome_2.txt'
    chainIDFile = templateBasedDir / 'interactome_chainIDs_2.txt'
    pdbIDFile = templateBasedDir / 'interactome_pdbIDs_2.txt'
    interfaceAnnotatedInteractomeFile1 = templateBasedDir / 'structural_interactome_withDuplicates_2.txt'
    interfaceAnnotatedInteractomeFile = templateBasedDir / 'structural_interactome_2.txt'
    refInteractomeChainMapFile = templateBasedDir / 'ref_interactome_chain_map_2.txt'
    strucInteractomeChainMapFile = templateBasedDir / 'struc_interactome_chain_map_2.txt'
