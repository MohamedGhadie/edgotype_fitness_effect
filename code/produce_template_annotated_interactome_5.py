...
def main():
    ...
    # output data files
    chainInterfaceFile = procDir / 'chain_interfaces_5.txt'
    ...
    chainAnnotatedInteractomeFile = templateBasedDir / 'chain_annotated_interactome_5.txt'
    chainIDFile = templateBasedDir / 'interactome_chainIDs_5.txt'
    pdbIDFile = templateBasedDir / 'interactome_pdbIDs_5.txt'
    interfaceAnnotatedInteractomeFile1 = templateBasedDir / 'structural_interactome_withDuplicates_5.txt'
    interfaceAnnotatedInteractomeFile = templateBasedDir / 'structural_interactome_5.txt'
    refInteractomeChainMapFile = templateBasedDir / 'ref_interactome_chain_map_5.txt'
    strucInteractomeChainMapFile = templateBasedDir / 'struc_interactome_chain_map_5.txt'
