...
def main():
    ...
    struc_name = {'HI-II-14':'Y2H-SI', 'HuRI':'Y2H-SI', 'IntAct':'Lit-SI', 'experiment':'Experiment'}
    
    # interactome colors
    interactome_color = {'HI-II-14':'yellow', 'HuRI':'limegreen', 'IntAct':'royalblue', 'experiment':'orangered'}
    ...
    natMutEdgotypeFile1 = procDir / interactome_names[0] / model_method / edgetic_method / (edgetic_ddg + '_edgetics') / 'nondisease_mutation_edgotype.txt'
    disMutEdgotypeFile1 = procDir / interactome_names[0] / model_method / edgetic_method / (edgetic_ddg + '_edgetics') / 'disease_mutation_edgotype.txt'
    if interactome_names[1] is 'experiment':
        natMutEdgotypeFile2 = procDir / 'experiment' / 'nondisease_mutation_edgotype.txt'
        disMutEdgotypeFile2 = procDir / 'experiment' / 'disease_mutation_edgotype.txt'
    else:
        natMutEdgotypeFile2 = procDir / interactome_names[1] / model_method / edgetic_method / (edgetic_ddg + '_edgetics') / 'nondisease_mutation_edgotype.txt'
        disMutEdgotypeFile2 = procDir / interactome_names[1] / model_method / edgetic_method / (edgetic_ddg + '_edgetics') / 'disease_mutation_edgotype.txt'
