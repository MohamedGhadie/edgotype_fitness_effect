...
def main():
    ...
    # output data files
    chainInterfaceFile = procDir / 'chain_interfaces_4.txt'
    ...
    chainAnnotatedInteractomeFile = templateBasedDir / 'chain_annotated_interactome_4.txt'
    chainIDFile = templateBasedDir / 'interactome_chainIDs_4.txt'
    pdbIDFile = templateBasedDir / 'interactome_pdbIDs_4.txt'
    interfaceAnnotatedInteractomeFile1 = templateBasedDir / 'structural_interactome_withDuplicates_4.txt'
    interfaceAnnotatedInteractomeFile = templateBasedDir / 'structural_interactome_4.txt'
    refInteractomeChainMapFile = templateBasedDir / 'ref_interactome_chain_map_4.txt'
    strucInteractomeChainMapFile = templateBasedDir / 'struc_interactome_chain_map_4.txt'
