...
def main():
    ...
    # output data files
    chainInterfaceFile = procDir / 'chain_interfaces_8.txt'
    ...
    chainAnnotatedInteractomeFile = templateBasedDir / 'chain_annotated_interactome_8.txt'
    chainIDFile = templateBasedDir / 'interactome_chainIDs.txt'
    pdbIDFile = templateBasedDir / 'interactome_pdbIDs.txt'
    interfaceAnnotatedInteractomeFile1 = templateBasedDir / 'structural_interactome_withDuplicates_8.txt'
    interfaceAnnotatedInteractomeFile = templateBasedDir / 'structural_interactome_8.txt'
    refInteractomeChainMapFile = templateBasedDir / 'ref_interactome_chain_map.txt'
    strucInteractomeChainMapFile = templateBasedDir / 'struc_interactome_chain_map_8.txt'
