...
def main():
    ...
    # output data files
    modelAnnotatedInteractomeFile = modelBasedDir / 'model_annotated_interactome_6.txt'
    chainSeqFile = modelBasedDir / 'ppi_chain_sequences.pkl'
    chainMapFile = modelBasedDir / 'struc_interactome_chain_map.txt'
    modelInterfaceFile = modelBasedDir / 'model_interfaces_6.txt'
    chainStrucResFile = modelBasedDir / 'ppi_chain_strucRes.pkl'

    structuralInteractomeFile1 = modelBasedDir / 'structural_interactome_withDuplicates_6.txt'
    structuralInteractomeFile = modelBasedDir / 'structural_interactome_6.txt'
